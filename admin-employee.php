    ...
    <section>
        <div class="table-bg">
            <table>
                ...
                <tbody>
                <?php $select = mysqli_query($conn,"SELECT * FROM users WHERE category != '' AND category != 'customer'AND category != 'admin'");
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="option">
                                ...
                                <a href="admin-employee.php?delete=<?php echo $row['userID']; ?>" class="op2" onclick="return confirm('Are you sure you want to delete this record?');"> Delete</a>
                            </div>
                        </td>
                    </tr>
                    <?php   };  ?>
